...
הציון ייקבע לפי  הגשה ורישום בזמן לפי ההנחיות (5%), איכות המסמך וההצגה בסקר עם צוות הקורס (70%),  תכני עמוד ה-SRS (~~התקדמות באב טיפו, סיכונים - 20%~~), תיקונים לפי סיכום סקר (10%), סקר וחוות דעת לקוח (15%).
