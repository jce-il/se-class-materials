...
### מטרת המשימה
הוחלט שהפיתוח המתאים ביותר להמשך הפרויקט הוא פיתוח בסבבים  (ספרינט \ איטרציה). כאשר בסוף כל סבב מנסים להוציא גרסה עובדת עם פונקציונליות נוספת של המוצר המפותח.
...
- מידע על מצב המשימות, בצורה של קישור קבוע לטבלאות משימות פתוחות וסגורות לסבב זה וכן ללוח ויזואלי של המשימות, כגון:
   ...
   - https://github.com/jce-il/se-class/projects/2
...
### 5. סקר סיום סבב (הצגה, סיכום ותכנון סבב הבא) 
...
הגשה – א. קישור לסקר מדף הסבב בוויקי ובמייל הגשת הסבב. ב. התייחסות קצרה לנושאים שעלו בסקר סיום סבב זה.
