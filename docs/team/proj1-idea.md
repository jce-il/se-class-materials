...
### עבודה והגשה
המשימה הנוכחית מתבצעת ביחידים, כל סטודנט סוקר הצעה ולכל אחת כותב ומפרסם דו״ח בטופס שלמטה.
...
בקורס זה אנחנו מפתחים מוצרי תוכנה עובר ארגונים חברתיים בירושלים שנענו לקול קורא (ניתן גם להירשם לקורס בחירה תמורת שעות העבודה עבור הארגון). הזמנו את הארגונים ליריד במכללה, זאת כדי ליצור קשר בלתי אמצעי בין הסטודנטים לארגונים. מומלץ לבקר בכמה שיותר ארגונים אך כל סטודנט נדרש לסקור הצעה אחת יותר לעומק. אם יש לכם עוד שאלות לארגונים לאחר היריד, אפשר ומומלץ גם לפנות לאיש הקשר של הארגון המצוין בהצעה בבקשה לבירור פרטים.
