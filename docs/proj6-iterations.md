...
- קוד – מפותח לפי עקרונות הנדסת תוכנה ומעודכן במאגר הפרויקט
...
###  2. מימוש סבב
תוך כדי המימוש המשימות מועברות עמודות בלוח huboard ונסגרות בסיומן (Ready -> Working -> Review -> Done, Close).<br/>
...
- מה עבד טוב ומה פחות בסבב? למשל:
  ...
  - אפשר גם לציין לקחים הקשורים לחומרי הקורס ההרצאה והתרגיל והאם עזרו (או להיפך..) להשלמת הסבב
...
ג. סקר קוד – הציגו קטע קוד משמעותי שכתבתם לצורך דיון עם הסוקרים. נשתמש בממשק הווב של גיטהאב להצגת הקוד ומתן הערות.<br/>
...
[issue-template]: https://github.com/robi-y/seproject-team-template/blob/master/.github/ISSUE_TEMPLATE.md
